...
var hljs = function () {
    ...
    }, k = t, M = r, {nodeStream: O, mergeStreams: L} = i, A = Symbol("nomatch");
    return function (t) {
        ...
        function E(e) {
            ...
            const r = n.textContent, a = t ? m(t, r, !0) : v(r), i = O(n);
            if (i.length) {
        ...
        Object.assign(t, {
            ...
            }, getLanguage: y, registerAliases: I, requireLanguage: function (e) {
                var n = y(e);
                if (n) return n;
                throw Error("The '{}' language is required, but not loaded.".replace("{}", e))
            }, autoDetection: T, inherit: M, addPlugin: function (e) {
                o.push(e)
            }, vuePlugin: R
...
hljs.registerLanguage("xml", function () {
    ...
    return function (e) {
        ...
        return {
            name: "HTML, XML",
            aliases: ["epub", "xhtml", "rss", "atom", "xjb", "xsd", "xsl", "plist", "wsf", "svg"],
            case_insensitive: !0,
            contains: [{
                className: "meta",
                begin: "<![a-z]",
    ...
    return function (e) {
        ...
        return {
            ...
            keywords: {
                ...
                literal: "true false",
                built_in: "break cd continue eval exec exit export getopts hash pwd readonly return shift Spring Boot Reference Documentation times trap umask unset alias bind builtin caller command declare echo enable help let local logout mapfile printf read readarray source type typeset ulimit unalias set shopt autoload bg bindkey bye cap chdir clone comparguments compcall compctl compdescribe compfiles compgroups compquote comptags comptry compvalues dirs disable disown echotc echoti emulate fc fg float functions getcap getln history integer jobs kill limit log noglob popd print pushd pushln rehash sched setcap setopt stat suspend ttyctl unfunction unhash unlimit unsetopt vared wait whence where which zcompile zformat zftp zle zmodload zparseopts zprof zpty zregexparse zsocket zstyle ztcp",
    ...
    return function (n) {
        ...
        return {
            ...
            contains: [n.SHEBANG(), a, i, t, s, {
                ...
                className: "attr",
                begin: "[A-Za-z0-9_$]+[ \t]*:"
            }, {begin: /\?/, end: /:/, contains: [a, i, t, s, "self"]}, {
                className: "symbol",
