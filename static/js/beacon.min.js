    ...
    var e = {
        343: function (e) {
            ...
            !function () {
                ...
                !function () {
                    var n, u,
                        ...
                        l = c(), v = [], p = window.__cfBeacon ? window.__cfBeacon : {};
                    if (!p || "single" !== p.load) {
                        if (d) {
            ...
            !function (e) {
                ...
                }, A = [.1, .25], _ = {passive: !0, capture: !0}, x = new Date, F = function (e, i) {
                ...
                e.CLSThresholds = A, e.FCPThresholds = B, e.FIDThresholds = M, e.INPThresholds = U, e.LCPThresholds = K, e.TTFBThresholds = Z, e.onCLS = function (e, t) {
                    ...
                    ee((function (t) {
                        !function (e) {
                            if (e.entries.length) {
                                var t = e.entries[0], n = t.activationStart || 0,
                                    r = Math.max(t.domainLookupStart - n, 0), i = Math.max(t.connectStart - n, 0),
